...
const CATEGORIES = [
  ...
  { id: "trending", label: "Trending", emoji: "📊", description: "Tokens ranked by popularity — views, holders, and activity." },
] as const;

const EXPLORE_TABLE_FETCH_LIMIT = 500;
...
export default function ExplorePage() {
  ...
  const { data: sectionTokens = [], isLoading: loadingSection } = useQuery({
    ...
    queryFn: () => fetchDiscoverTokens(category, EXPLORE_TABLE_FETCH_LIMIT, filters),
